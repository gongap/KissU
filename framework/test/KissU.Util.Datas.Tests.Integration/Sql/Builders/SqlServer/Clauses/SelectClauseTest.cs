...
namespace KissU.Util.Datas.Tests.Integration.Sql.Builders.SqlServer.Clauses
{
    ...
    public class SelectClauseTest
    {
        ...
        {
            _clause = new SelectClause(new SqlServerBuilder(), new SqlServerDialect(), new EntityResolver(),
        ...
        {
            _clause = new SelectClause(new SqlServerBuilder(), new SqlServerDialect(), new TestEntityResolver(),
                new EntityAliasRegister());
            _clause.Select<Sample>(t => new object[] {t.Email, t.IntValue});
        ...
        {
            _clause = new SelectClause(new SqlServerBuilder(), new SqlServerDialect(),
                new EntityResolver(new TestEntityMatedata()), new TestEntityAliasRegister());
            _clause.Select<Sample>(t => new Dictionary<object, string> {{t.Email, "e"}, {t.Url, "u"}});
            var result = _clause.ToSql();
        ...
        public void TestSelect_25()
        {
            ...
            var result = _clause.ToSql();
            Assert.Equal("Select [as_Sample].[Sample_Email] As [Email],[as_Sample].[Sample_IntValue] As [IntValue]",
                result);
        }
