...
namespace KissU.Surging.Protocol.Mqtt.Internal.Services.Implementation
{
    /// <summary>
    /// MqttChannelService.
    /// Implements the <see cref="KissU.Surging.Protocol.Mqtt.Internal.Services.AbstractChannelService" />
    /// </summary>
    /// <seealso cref="KissU.Surging.Protocol.Mqtt.Internal.Services.AbstractChannelService" />
