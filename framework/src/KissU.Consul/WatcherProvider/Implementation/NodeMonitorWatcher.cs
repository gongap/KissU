...
using Consul;
using KissU.Consul.Utilitys;

namespace KissU.Consul.WatcherProvider.Implementation
{
    /// <summary>
    /// NodeMonitorWatcher.
    /// Implements the <see cref="KissU.Consul.WatcherProvider.Implementation.WatcherBase" />
    /// </summary>
    /// <seealso cref="KissU.Consul.WatcherProvider.Implementation.WatcherBase" />
