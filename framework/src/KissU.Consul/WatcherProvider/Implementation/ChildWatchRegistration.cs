...
namespace KissU.Consul.WatcherProvider.Implementation
{
    ...
    /// Implements the <see cref="KissU.Consul.WatcherProvider.Implementation.WatchRegistration" />
    /// </summary>
    /// <seealso cref="KissU.Consul.WatcherProvider.Implementation.WatchRegistration" />
