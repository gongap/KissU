...
namespace KissU.Surging.Consul.Internal.Implementation
{
    /// <summary>
    /// DefaultConsulClientProvider.
    /// Implements the <see cref="KissU.Surging.Consul.Internal.IConsulClientProvider" />
    /// </summary>
    /// <seealso cref="KissU.Surging.Consul.Internal.IConsulClientProvider" />
