...
namespace KissU.Util.Search.ElasticSearch
{
    ...
    public static partial class Extensions
    {
        ...
        public static async Task<CreateIndexResponse> CreateIndexAsync(this IElasticSearch source, string index,
            string alias = null,
        ...
        /// </summary>
        /// <param name="source">服务</param>
        public static async Task<DeleteIndexResponse> DeleteIndexAsync<TDocument>(this IElasticSearch source)
        ...
        public static async Task AddIndexesToAliasAsync(this IElasticSearch source, string alias,
        ...
        /// <param name="alias">别名</param>
        /// <param name="indexes">索引名称列表</param>
        public static async Task RemoveIndexesFromAliasAsync(this IElasticSearch source, string alias,
            params string[] indexes)
        {
            source.CheckNull(nameof(source));
            if (alias.IsEmpty())
