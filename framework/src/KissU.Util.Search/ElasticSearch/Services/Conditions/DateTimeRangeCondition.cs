...
namespace KissU.Util.Search.ElasticSearch.Services.Conditions
{
    ...
    /// </summary>
    public class
        DateTimeRangeCondition<TEntity, TProperty> : RangeConditionBase<TEntity, TProperty, DateTime, DateRangeQuery>
        where TEntity : class
    {
        /// <summary>
        /// 初始化日期范围过滤条件
        ...
        public DateTimeRangeCondition(Expression<Func<TEntity, TProperty>> propertyExpression, DateTime? min,
