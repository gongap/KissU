...
namespace KissU.Protocol.Mqtt.Internal.Services.Implementation
{
    /// <summary>
    /// MqttChannelService.
    /// Implements the <see cref="KissU.Protocol.Mqtt.Internal.Services.AbstractChannelService" />
    /// </summary>
    /// <seealso cref="KissU.Protocol.Mqtt.Internal.Services.AbstractChannelService" />
