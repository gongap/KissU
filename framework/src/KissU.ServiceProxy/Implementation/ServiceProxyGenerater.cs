...
using KissU.ServiceProxy.Utilitys;
...
namespace KissU.ServiceProxy.Implementation
{
    ...
    /// Implements the <see cref="IServiceProxyGenerater" />
    /// Implements the <see cref="System.IDisposable" />
    /// </summary>
    /// <seealso cref="IServiceProxyGenerater" />
        ...
        private static SyntaxList<UsingDirectiveSyntax> GetUsings(IEnumerable<string> namespaces)
        {
            ...
            return SyntaxFactory.List(
                new[]
                {
                    ...
                    SyntaxFactory.UsingDirective(GetQualifiedNameSyntax(typeof(IServiceRouteProvider).Namespace)),
                    ...
                    SyntaxFactory.ParameterList(
                        SyntaxFactory.SeparatedList<ParameterSyntax>(
                            new SyntaxNodeOrToken[]
                            {
                                ...
                                SyntaxFactory.Token(SyntaxKind.CommaToken),
                                SyntaxFactory.Parameter(
                                        SyntaxFactory.Identifier("serviceRouteProvider"))
                                    .WithType(
                                        SyntaxFactory.IdentifierName("IServiceRouteProvider"))
                            })))
                .WithInitializer(
                        ...
                        SyntaxFactory.ArgumentList(
                            SyntaxFactory.SeparatedList<ArgumentSyntax>(
                                new SyntaxNodeOrToken[]
                                {
                                    ...
                                    SyntaxFactory.Token(SyntaxKind.CommaToken),
                                    SyntaxFactory.Argument(
                                        SyntaxFactory.IdentifierName("serviceRouteProvider"))
                                }))))
