...
using KissU.ProxyGenerator.Implementation;

namespace KissU.ProxyGenerator.Interceptors.Implementation
{
    /// <summary>
    /// ActionInvocation.
    /// Implements the <see cref="KissU.ProxyGenerator.Interceptors.Implementation.AbstractInvocation" />
    /// </summary>
    /// <seealso cref="KissU.ProxyGenerator.Interceptors.Implementation.AbstractInvocation" />
