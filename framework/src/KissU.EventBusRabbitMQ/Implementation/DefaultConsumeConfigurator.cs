...
using KissU.EventBusRabbitMQ.Utilities;

namespace KissU.EventBusRabbitMQ.Implementation
{
    /// <summary>
    /// DefaultConsumeConfigurator.
    /// Implements the <see cref="KissU.EventBusRabbitMQ.IConsumeConfigurator" />
    /// </summary>
    /// <seealso cref="KissU.EventBusRabbitMQ.IConsumeConfigurator" />
