...
using KissU.Protocol.WS.Configurations;
using Microsoft.Extensions.Logging;
using WebSocketCore.Server;

namespace KissU.Protocol.WS.Runtime.Implementation
{
    /// <summary>
    /// DefaultWSServiceEntryProvider.
    /// Implements the <see cref="KissU.Protocol.WS.Runtime.IWSServiceEntryProvider" />
    /// </summary>
    /// <seealso cref="KissU.Protocol.WS.Runtime.IWSServiceEntryProvider" />
