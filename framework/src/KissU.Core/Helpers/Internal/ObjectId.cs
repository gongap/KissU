...
namespace KissU.Helpers.Internal
{
    /// <summary>
    ...
    internal struct ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>
    {
        ...
        /// machine - The machine value must be between 0 and 16777215 (it must fit
        /// in 3 bytes).
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// increment - The increment value must be between 0 and 16777215 (it must
        /// fit in 3 bytes).
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// machine - The machine value must be between 0 and 16777215 (it must fit
