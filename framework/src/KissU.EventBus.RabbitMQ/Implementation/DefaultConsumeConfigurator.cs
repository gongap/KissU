...
using KissU.EventBus.RabbitMQ.Utilities;

namespace KissU.EventBus.RabbitMQ.Implementation
{
    /// <summary>
    /// DefaultConsumeConfigurator.
    /// Implements the <see cref="IConsumeConfigurator" />
    /// </summary>
    /// <seealso cref="IConsumeConfigurator" />
