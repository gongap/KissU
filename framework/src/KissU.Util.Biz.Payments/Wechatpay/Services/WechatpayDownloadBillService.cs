...
using KissU.Util.Biz.Payments.Wechatpay.Services.CsvMappings;
using TinyCsvParser;
...
namespace KissU.Util.Biz.Payments.Wechatpay.Services
{
    ...
    /// 微信支付下载对账单服务
    /// </summary>
    public class WechatpayDownloadBillService : WechatpayServiceBase<WechatpayDownloadBillRequest>,
        IWechatpayDownloadBillService
    {
        /// <summary>
        /// 初始化微信支付下载对账单服务
        /// </summary>
        ...
        /// 请求结果
        /// </summary>
        protected async Task<WechatpayDownloadBillResult> Requst(WechatpayConfig config,
            WechatpayParameterBuilder builder, WechatpayDownloadBillRequest request)
        {
        ...
        /// 请求失败
        /// </summary>
        private WechatpayDownloadBillResult Success(string response, WechatpayParameterBuilder builder,
            WechatpayDownloadBillRequest request)
        {
        ...
        /// 请求失败
        /// </summary>
        private async Task<WechatpayDownloadBillResult> Fail(string response, WechatpayConfig config,
