...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class AbpAutofacServiceCollectionExtensions
    {
        ...
        public static ContainerBuilder GetContainerBuilder([NotNull] this IServiceCollection services)
        {
            ...
            if (builder == null)
            {
                throw new AbpException($"Could not find ContainerBuilder. Be sure that you have called {nameof(ApplicationCreationOptionsExtensions.UseAutofac)} method before!");
            }
