...
namespace KissU.Util.Ddd.Domain.Datas.Sql.Queries
{
    /// <summary>
    /// Sql查询对象
    /// </summary>
    public abstract class SqlQueryBase : ISqlQuery, IClauseAccessor, IUnionAccessor, ICteAccessor
    {
        ...
        /// <exception cref="ArgumentNullException">sqlBuilder</exception>
        ...
        /// <param name="connection">数据库连接</param>
        /// <returns>PagerList&lt;TResult&gt;.</returns>
        public abstract PagerList<TResult>
            ToPagerList<TResult>(int page, int pageSize, IDbConnection connection = null);
        ...
        /// <param name="connection">数据库连接</param>
        /// <returns>Task&lt;PagerList&lt;TResult&gt;&gt;.</returns>
        public abstract Task<PagerList<TResult>> ToPagerListAsync<TResult>(int page, int pageSize,
            IDbConnection connection = null);
        ...
        /// <param name="connection">数据库连接</param>
        /// <returns>Task&lt;PagerList&lt;TResult&gt;&gt;.</returns>
        public abstract Task<PagerList<TResult>> ToPagerListAsync<TResult>(string sql, int page, int pageSize,
            IDbConnection connection = null);
        ...
        /// <param name="connection">数据库连接</param>
        /// <returns>TResult.</returns>
        public TResult Query<TResult>(Func<IDbConnection, string, IReadOnlyDictionary<string, object>, TResult> func,
            IDbConnection connection = null)
        {
            var sql = GetSql();
        ...
        protected abstract void WriteTraceLog(string sql, IReadOnlyDictionary<string, object> parameters,
            string debugSql);
