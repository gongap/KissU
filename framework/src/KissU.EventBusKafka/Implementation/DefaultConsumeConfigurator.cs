...
using KissU.EventBusKafka.Utilities;

namespace KissU.EventBusKafka.Implementation
{
    /// <summary>
    /// DefaultConsumeConfigurator.
    /// Implements the <see cref="KissU.EventBusKafka.IConsumeConfigurator" />
    /// </summary>
    /// <seealso cref="KissU.EventBusKafka.IConsumeConfigurator" />
