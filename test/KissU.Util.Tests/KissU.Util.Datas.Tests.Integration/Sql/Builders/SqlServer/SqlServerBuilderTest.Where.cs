...
namespace KissU.Util.Datas.Tests.Integration.Sql.Builders.SqlServer
{
    ...
    public partial class SqlServerBuilderTest
    {
        ...
        public void TestOrIfNotEmpty()
        {
            ...
            //执行
            _builder.From<Sample>("s").OrIfNotEmpty<Sample>(t => t.Email == "")
                .Or<Sample>(t => t.Email == "a", t => t.Url != "b");
        ...
        public void TestWhere_7()
        {
            ...
            _builder.From("abc.Test")
                .Where("b2", builder => { builder.Count().From("Test2").Where("Name", "a"); }, Operator.NotEqual)
                .Where("Age", 1);
            _output.WriteLine(_builder.ToSql());
        ...
        public void TestWhere_8()
        {
            ...
            //执行
            _builder.From<Sample>("s").Where<Sample>(t => t.Email,
                builder => { builder.Count().From("Test2").Where("Name", "a"); }, Operator.NotEqual).Where("Age", 1);
            _output.WriteLine(_builder.ToSql());
        ...
        public void TestWhereIf_4()
        {
            ...
            //执行
            var builder2 = _builder.New().Count().From("Test2").Where("Name", "a");
            _builder.From("abc.Test").WhereIf("a", builder2, false).WhereIf("b2", builder2, true, Operator.NotEqual)
                .Where("Age", 1);
            _output.WriteLine(_builder.ToSql());
        ...
        public void TestWhereIf_6()
        {
            ...
            //执行
            _builder.From("abc.Test")
                .WhereIf("b2", builder => { builder.Count().From("a").Where("Name", "b"); }, false)
                .WhereIf("b2", builder => { builder.Count().From("Test2").Where("Name", "a"); }, true,
                    Operator.NotEqual)
                .Where("Age", 1);
            _output.WriteLine(_builder.ToSql());
        ...
        public void TestWhereIf_7()
        {
            ...
            //执行
            _builder.From<Sample>("s")
                .WhereIf<Sample>(t => t.Email, builder => { builder.Count().From("a").Where("Name", "b"); }, false)
                .WhereIf<Sample>(t => t.Email, builder => { builder.Count().From("Test2").Where("Name", "a"); }, true,
                    Operator.NotEqual)
                .Where("Age", 1);
            _output.WriteLine(_builder.ToSql());
