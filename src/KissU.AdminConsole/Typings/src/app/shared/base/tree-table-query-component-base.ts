...
import { MessageConfig } from '@core/util/config/message-config';
import { PagerList } from "@core/util/core/pager-list";
import { TreeViewModel, TreeQueryParameter } from "@core/util/core/tree-model";
...
export abstract class TreeTableQueryComponentBase<TViewModel extends TreeViewModel, TQuery extends TreeQueryParameter> extends QueryComponentBase implements OnInit {
     ...
     * 树形表格组件
     */
    @ViewChild(forwardRef(() => TreeTable), null ) protected table: TreeTable<TViewModel>;
