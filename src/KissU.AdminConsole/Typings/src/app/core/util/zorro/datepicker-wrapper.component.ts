    ...
    >
      <ng-container [ngSwitch]="type">
        <ng-container *ngSwitchCase="'date'">
          ...
          <nz-form-explain
            *ngIf="controlModel?.hasError('required') && (controlModel?.dirty || controlModel.touched)"
            >{{ requiredMessage }}</nz-form-explain
          >
        </ng-container>
...
export class DatePicker extends FormControlWrapperBase {
  ...
  disableDate = (value: Date): boolean => {
    if (this.disabledDateFunc) return this.disabledDateFunc(value);
    if (this.disabledBeforeToday) return util.helper.isBeforeToday(value);
    if (this.disabledBeforeTomorrow) return this.disableBeforeTomorrow(value);
    return false;
  };
