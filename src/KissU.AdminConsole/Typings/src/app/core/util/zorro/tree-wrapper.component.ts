...
export class Tree implements AfterContentInit {
   ...
   * 树形组件
   */
  @ViewChild(forwardRef(() => NzTreeComponent), null) protected tree: NzTreeComponent;
   ...
   * @param option 参数
   */
  query(option?: { url?: string; param?; before?: () => boolean; complete?: () => void; ok?: (value) => void }) {
    option = option || {};
