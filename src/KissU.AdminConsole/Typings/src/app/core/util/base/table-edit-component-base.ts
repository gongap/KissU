 ...
 * 表格编辑基类
 */
export abstract class TableEditComponentBase<
  TViewModel extends ViewModel,
  TQuery extends QueryParameter
> extends TableQueryComponentBase<TViewModel, TQuery> {
  /**
   * 编辑表格指令
   */
  @ViewChild(forwardRef(() => EditTableDirective), null) protected editTable: EditTableDirective;
