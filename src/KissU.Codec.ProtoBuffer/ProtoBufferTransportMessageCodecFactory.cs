...
namespace KissU.Codec.ProtoBuffer
{
    ...
    /// Implements the <see cref="KissU.CPlatform.Transport.Codec.ITransportMessageCodecFactory" />
    /// </summary>
    /// <seealso cref="KissU.CPlatform.Transport.Codec.ITransportMessageCodecFactory" />
