...
namespace KissU.DotNetty.Mqtt
{
    ...
    public class MqttProtocolModule : EnginePartModule
    {
        ...
        protected override void ConfigureContainer(ContainerBuilderWrapper builder)
        {
            ...
            if (AppConfig.ServerOptions.Protocols == nameof(CommunicationProtocol.Mqtt))
            {
                RegisterDefaultProtocol(builder);
            }
            else if (AppConfig.ServerOptions.Protocols == nameof(CommunicationProtocol.None) || AppConfig.ServerOptions.Protocols.Contains(nameof(CommunicationProtocol.Mqtt)))
            {
