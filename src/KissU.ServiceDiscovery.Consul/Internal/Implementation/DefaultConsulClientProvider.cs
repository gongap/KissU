...
namespace KissU.ServiceDiscovery.Consul.Internal.Implementation
{
    /// <summary>
    /// DefaultConsulClientProvider.
    /// Implements the <see cref="IConsulClientProvider" />
    /// </summary>
    /// <seealso cref="IConsulClientProvider" />
