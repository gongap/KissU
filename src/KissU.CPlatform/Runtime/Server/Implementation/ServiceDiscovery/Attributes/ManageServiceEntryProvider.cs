...
{
    /// <summary>
    /// ManageService标记类型的服务条目提供程序。
    /// </summary>
    public class ManageServiceEntryProvider : IServiceEntryProvider
    {
        ...
        public ManageServiceEntryProvider(IEnumerable<Type> types, IClrServiceEntryFactory clrServiceEntryFactory, CPlatformContainer serviceProvider)
        {
        ...
        public IEnumerable<ServiceEntry> GetEntries()
        {
            ...
            {
                entries.AddRange(_clrServiceEntryFactory.CreateServiceEntry(service, "api/manage/{ManageService}/{Async}" ,enableAuthorization:IEnableAuthorization));
            }
        ...
        private static bool IsRemoteService(Type type)
        {
            ...
            if (type.IsInterface &&  typeof(IManageServiceKey) != type &&  typeof(IManageServiceKey).IsAssignableFrom(type))
            {
                return true;
            }
        ...
        private bool IEnableAuthorization(MethodInfo methodInfo)
        {
            return true;
        }
    }
