...
namespace KissU.CPlatform.Configurations
{
    ...
    public class ServerEngineOptions : ServiceCommand
    {
        ...
        /// </summary>
        public string Protocols { get; set; } = nameof(CommunicationProtocol.None);
        ...
        /// </summary>
        public bool IsCamelCaseResolver { get; set; } = true;

        /// <summary>
        /// AlwaysAllowAuthorization
        /// </summary>
        public bool AlwaysAllowAuthorization { get; set; } = false;

        /// <summary>
        /// PushSkyApmLog
        /// </summary>
        public  bool PushSkyApmLog { get; set; }= true;
