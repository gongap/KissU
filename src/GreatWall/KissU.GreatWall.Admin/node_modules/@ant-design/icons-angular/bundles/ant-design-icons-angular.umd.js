(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ant-design/colors'), require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ant-design/icons-angular', ['exports', '@ant-design/colors', '@angular/common', '@angular/common/http', '@angular/core', '@angular/platform-browser', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global['ant-design'] = global['ant-design'] || {}, global['ant-design']['icons-angular'] = {}),global.colors,global.ng.common,global.ng.common.http,global.ng.core,global.ng.platformBrowser,global.rxjs,global.rxjs.operators));
}(this, (function (exports,colors,common,http,core,platformBrowser,rxjs,operators) { 'use strict';
         ...
         */
            function (type) {
                ...
                if (!inProgress) {
                    ...
                    inProgress = this._http.get(safeUrl, { responseType: 'text' }).pipe(operators.map(( /**
                     * @param {?} literal
                     * @return {?}
                     */function (literal) { return (__assign({}, icon_1, { icon: literal })); })), operators.tap(( /**
                     * @param {?} definition
                     * @return {?}
