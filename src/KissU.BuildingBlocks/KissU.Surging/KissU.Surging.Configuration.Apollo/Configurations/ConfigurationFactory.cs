...
namespace KissU.Surging.Configuration.Apollo.Configurations
{
    ...
    /// Implements the <see cref="KissU.Surging.Configuration.Apollo.Configurations.IConfigurationFactory" />
    /// </summary>
    /// <seealso cref="KissU.Surging.Configuration.Apollo.Configurations.IConfigurationFactory" />
