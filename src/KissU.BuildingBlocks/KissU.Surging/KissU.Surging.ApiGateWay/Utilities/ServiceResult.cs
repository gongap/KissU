namespace KissU.Surging.ApiGateWay.Utilities
{
    /// <summary>
    /// 自定义错误结果对象
    /// </summary>
    ...
    /// <summary>
    /// ServiceResult.
    /// Implements the <see cref="KissU.Surging.ApiGateWay.Utilities.ServiceResult" />
    /// </summary>
    /// <seealso cref="KissU.Surging.ApiGateWay.Utilities.ServiceResult" />
