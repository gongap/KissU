...
namespace KissU.Surging.KestrelHttpServer.Abstractions
{
    /// <summary>
    /// FileResult.
    /// Implements the <see cref="KissU.Surging.KestrelHttpServer.Abstractions.ActionResult" />
    /// </summary>
    /// <seealso cref="KissU.Surging.KestrelHttpServer.Abstractions.ActionResult" />
