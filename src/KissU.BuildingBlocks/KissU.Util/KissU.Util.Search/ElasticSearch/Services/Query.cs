...
namespace KissU.Util.Search.ElasticSearch.Services
{
    ...
    public class Query<TResult> : ICondition where TResult : class
    {
        ...
        public Query<TResult> TermIf<TProperty>(Expression<Func<TResult, TProperty>> expression, object value,
            bool condition)
        {
        ...
        public Query<TResult> Terms<TProperty>(Expression<Func<TResult, TProperty>> expression,
        ...
        /// <param name="values">值</param>
        /// <param name="condition">为true时才添加条件</param>
        public Query<TResult> TermsIf<TProperty>(Expression<Func<TResult, TProperty>> expression,
        ...
        /// <param name="expression">字段表达式</param>
        /// <param name="values">值</param>
        public Query<TResult> TermsIfNotEmpty<TProperty>(Expression<Func<TResult, TProperty>> expression,
            IEnumerable<object> values)
        {
            if (values == null)
                return this;
        ...
        /// <param name="value">值</param>
        /// <param name="condition">为true时才添加条件</param>
        public Query<TResult> MatchIf<TProperty>(Expression<Func<TResult, TProperty>> expression, string value,
            bool condition)
        {
        ...
        public Query<TResult> Between<TProperty>(Expression<Func<TResult, TProperty>> propertyExpression, int? min,
        ...
        /// <param name="max">最大值</param>
        /// <param name="boundary">包含边界</param>
        public Query<TResult> BetweenIf<TProperty>(Expression<Func<TResult, TProperty>> propertyExpression,
        ...
        /// <param name="max">最大值</param>
        /// <param name="boundary">包含边界</param>
        public Query<TResult> Between<TProperty>(Expression<Func<TResult, TProperty>> propertyExpression, double? min,
        ...
        /// <param name="boundary">包含边界</param>
        public Query<TResult> Between<TProperty>(Expression<Func<TResult, TProperty>> propertyExpression, DateTime? min,
            DateTime? max, bool includeTime = true, Boundary? boundary = null)
        {
            if (includeTime)
                return And(new DateTimeRangeCondition<TResult, TProperty>(propertyExpression, min, max,
                    boundary ?? Boundary.Both));
            return And(new DateRangeCondition<TResult, TProperty>(propertyExpression, min, max,
