...
namespace KissU.Util.Search.ElasticSearch.Services.Conditions
{
    ...
    /// </summary>
    public class
        DoubleRangeCondition<TEntity, TProperty> : RangeConditionBase<TEntity, TProperty, double, NumericRangeQuery>
        where TEntity : class
    {
        /// <summary>
        /// 初始化double范围过滤条件
        ...
        public DoubleRangeCondition(Expression<Func<TEntity, TProperty>> propertyExpression, double? min, double? max,
