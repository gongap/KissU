...
namespace KissU.Util.Search.ElasticSearch.Services.Conditions
{
    ...
    /// 日期范围过滤条件 - 不包含时间
    /// </summary>
    public class DateRangeCondition<TEntity, TProperty> : DateTimeRangeCondition<TEntity, TProperty>
        where TEntity : class
    {
        /// <summary>
        /// 初始化日期范围过滤条件
        ...
        public DateRangeCondition(Expression<Func<TEntity, TProperty>> propertyExpression, DateTime? min, DateTime? max,
