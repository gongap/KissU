...
namespace KissU.Util.Search.ElasticSearch.Services.Conditions
{
    ...
    /// long范围过滤条件
    /// </summary>
    public class LongRangeCondition<TEntity, TProperty> : RangeConditionBase<TEntity, TProperty, long, LongRangeQuery>
        where TEntity : class
    {
        /// <summary>
        /// 初始化long范围过滤条件
        ...
        public LongRangeCondition(Expression<Func<TEntity, TProperty>> propertyExpression, long? min, long? max,
