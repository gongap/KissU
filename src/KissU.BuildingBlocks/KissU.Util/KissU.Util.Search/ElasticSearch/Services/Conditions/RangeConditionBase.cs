...
namespace KissU.Util.Search.ElasticSearch.Services.Conditions
{
    ...
    /// 范围过滤条件
    /// </summary>
    public abstract class RangeConditionBase<TEntity, TProperty, TValue, TQuery> : ICondition where TEntity : class
        where TValue : struct
        where TQuery : QueryBase
    {
        ...
        protected RangeConditionBase(Expression<Func<TEntity, TProperty>> propertyExpression, TValue? min, TValue? max,
            Boundary boundary)
        {
