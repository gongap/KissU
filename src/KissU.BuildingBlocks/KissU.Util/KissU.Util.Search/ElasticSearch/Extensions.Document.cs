...
namespace KissU.Util.Search.ElasticSearch
{
    ...
    public static partial class Extensions
    {
        ...
        public static async Task<IndexResponse> AddAsync<TDocument>(this IElasticSearch source, TDocument document,
            string index = null, string id = null) where TDocument : class
        {
        ...
        public static async Task<BulkResponse> AddListAsync<TDocument>(this IElasticSearch source,
        ...
        /// <param name="id">文档标识</param>
        /// <param name="index">索引名称，注意：必须小写</param>
        public static async Task<DeleteResponse> DeleteAsync<TDocument>(this IElasticSearch source, string id,
            string index = null) where TDocument : class
        {
            source.CheckNull(nameof(source));
            index = GetIndex<TDocument>(index);
