...
namespace KissU.Util.Datas.Sql
{
    ...
    public static partial class Extensions
    {
        ...
        /// <returns>T.</returns>
        /// <exception cref="ArgumentNullException">source</exception>
        public static T Where<T>(this T source, string column, Action<ISqlBuilder> action,
            Operator @operator = Operator.Equal) where T : IWhere
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (source is IClauseAccessor accessor)
        ...
        /// <param name="operator">运算符</param>
        /// <returns>T.</returns>
        public static T WhereIf<T>(this T source, string column, object value, bool condition,
            Operator @operator = Operator.Equal) where T : IWhere
        {
        ...
        /// <param name="operator">运算符</param>
        /// <returns>T.</returns>
        public static T WhereIf<T>(this T source, string column, ISqlBuilder builder, bool condition,
            Operator @operator = Operator.Equal) where T : IWhere
        {
        ...
        /// <param name="operator">运算符</param>
        /// <returns>T.</returns>
        public static T WhereIf<T>(this T source, string column, Action<ISqlBuilder> action, bool condition,
            Operator @operator = Operator.Equal) where T : IWhere
        {
        ...
        /// <returns>T.</returns>
        /// <exception cref="ArgumentNullException">source</exception>
        public static T WhereIfNotEmpty<T>(this T source, string column, object value,
            Operator @operator = Operator.Equal) where T : IWhere
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// <returns>T.</returns>
        /// <exception cref="ArgumentNullException">source</exception>
        public static T Between<T>(this T source, string column, double? min, double? max,
            Boundary boundary = Boundary.Both) where T : IWhere
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (source is IClauseAccessor accessor)
        ...
        /// <returns>T.</returns>
        /// <exception cref="ArgumentNullException">source</exception>
        public static T Between<T>(this T source, string column, decimal? min, decimal? max,
            Boundary boundary = Boundary.Both) where T : IWhere
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// <returns>T.</returns>
        /// <exception cref="ArgumentNullException">source</exception>
        public static T Between<T>(this T source, string column, DateTime? min, DateTime? max, bool includeTime = true,
            Boundary? boundary = null) where T : IWhere
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (source is IClauseAccessor accessor)
