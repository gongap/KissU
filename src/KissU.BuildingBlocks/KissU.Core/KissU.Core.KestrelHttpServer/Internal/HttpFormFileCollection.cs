...
namespace KissU.Core.KestrelHttpServer.Internal
{
    ...
    /// Implements the <see cref="System.Collections.Generic.List{KissU.Core.KestrelHttpServer.Internal.HttpFormFile}" />
    /// </summary>
    /// <seealso cref="System.Collections.Generic.List{KissU.Core.KestrelHttpServer.Internal.HttpFormFile}" />
