...
namespace KissU.Core.ProxyGenerator.Diagnostics
{
    ...
    /// Implements the <see cref="KissU.Core.CPlatform.Diagnostics.ICarrierHeaderCollection" />
    /// </summary>
    /// <seealso cref="KissU.Core.CPlatform.Diagnostics.ICarrierHeaderCollection" />
