...
namespace KissU.Core.CPlatform.Module
{
    ...
    public class AssemblyEntry : IXmlSerializable
    {
        ...
        /// <returns><para>一个有符号整数，它指示两个对象的相对值，如下表所示。返回值含义小于零当前的 System.Version 对象是 version 之前的一个版本。</para>
        /// <para>零当前的System.Version 对象是与 version 相同的版本。大于零当前 System.Version 对象是 version 之后的一个版本。-或 -version 为 null。</para></returns>
