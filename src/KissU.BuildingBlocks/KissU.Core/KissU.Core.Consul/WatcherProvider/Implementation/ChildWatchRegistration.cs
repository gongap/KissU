...
namespace KissU.Core.Consul.WatcherProvider.Implementation
{
    ...
    /// Implements the <see cref="KissU.Core.Consul.WatcherProvider.Implementation.WatchRegistration" />
    /// </summary>
    /// <seealso cref="KissU.Core.Consul.WatcherProvider.Implementation.WatchRegistration" />
