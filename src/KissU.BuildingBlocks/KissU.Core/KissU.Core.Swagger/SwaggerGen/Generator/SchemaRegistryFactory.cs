...
namespace KissU.Core.Swagger.SwaggerGen.Generator
{
    ...
    /// Implements the <see cref="KissU.Core.Swagger.SwaggerGen.Generator.ISchemaRegistryFactory" />
    /// </summary>
    /// <seealso cref="KissU.Core.Swagger.SwaggerGen.Generator.ISchemaRegistryFactory" />
