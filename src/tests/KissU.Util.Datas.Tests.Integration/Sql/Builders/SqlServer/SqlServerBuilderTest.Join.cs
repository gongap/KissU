...
namespace KissU.Util.Datas.Tests.Integration.Sql.Builders.SqlServer
{
    ...
    public partial class SqlServerBuilderTest
    {
        ...
        public void TestLeftJoin_7()
        {
            ...
            result.Append(
                "Left Join [Sample2] As [b] On [a].[Email]=[b].[StringValue] And [a].[IntValue]<>[b].[IntValue]");
            ...
            _builder.Select<Sample>(t => new object[] {t.Email, t.BoolValue})
                ...
                .From<Sample>("a")
                .LeftJoin<Sample2>("b")
                .On<Sample, Sample2>((l, r) => l.Email == r.StringValue && l.IntValue != r.IntValue);
        ...
        public void TestOn_4()
        {
            ...
            _builder.Select("a,b")
                .From<Sample>("s")
                .LeftJoin<Sample2>("s2")
                .On<Sample, Sample2>((l, r) => l.IntValue == r.IntValue && l.StringValue == "a");
