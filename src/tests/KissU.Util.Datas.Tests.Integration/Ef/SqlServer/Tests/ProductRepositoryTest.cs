...
namespace KissU.Util.Datas.Tests.Integration.Ef.SqlServer.Tests
{
    ...
    public class ProductRepositoryTest : IDisposable
    {
        ...
        public void TestAdd()
        {
            var id = _random.Next(999999999);
            var product = new Product(id) {Name = "Name", Code = "Code"};
            product.ProductType = new ProductType("Type",
                new List<ProductProperty> {new ProductProperty("A", "1"), new ProductProperty("B", "2")});
        ...
        {
            var id = _random.Next(999999999);
            var id2 = _random.Next(999999999);
            var product = new Product(id) {Name = "Name", Code = "Code"};
