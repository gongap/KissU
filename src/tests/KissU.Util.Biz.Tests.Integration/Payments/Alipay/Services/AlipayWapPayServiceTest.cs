...
namespace KissU.Util.Biz.Tests.Integration.Payments.Alipay.Services
{
    ...
    /// 支付宝手机网站支付服务测试
    /// </summary>
    public class AlipayWapPayServiceTest : IDisposable
    {
        /// <summary>
        /// 测试初始化
        /// </summary>
        ...
        public async Task TestPayAsync()
        {
            ...
            result.Append(
                "<input name=\"biz_content\" value=\"{'out_trade_no':'59f7caeeab89e009e4a4e1fb','subject':'test','total_amount':'10','timeout_express':'90m'}\"></input>");
