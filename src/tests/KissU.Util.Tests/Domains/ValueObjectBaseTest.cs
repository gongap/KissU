...
namespace KissU.Util.Tests.Domains
{
    ...
    public class ValueObjectBaseTest
    {
        ...
        /// 值对象测试样例4
        /// </summary>
        private readonly ValueObjectSample _sample4;

        /// <summary>
        /// 值对象测试样例5
        /// </summary>
        private readonly ValueObjectSample _sample5;

        /// <summary>
        /// 值对象测试样例6
        /// </summary>
        private readonly ValueObjectSample _sample6;

        /// <summary>
        /// 值对象测试样例7
        /// </summary>
        private readonly ValueObjectSample _sample7;

        /// <summary>
        /// 聚合根测试样例
        /// </summary>
        private readonly AggregateRootSample _aggregateRootSample;
