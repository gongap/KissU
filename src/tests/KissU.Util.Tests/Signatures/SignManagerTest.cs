...
namespace KissU.Util.Tests.Signatures
{
    /// <summary>
    /// 签名服务测试
    /// </summary>
    public class SignManagerTest
    {
        ...
        {
            const string result =
                "";
            _manager.Add("sign_type", "RSA2");
            _manager.Add("d", "");
            _manager.Add("c", "12");
            _manager.Add("a", "2");
