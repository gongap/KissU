...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */,e.padStart=function jt(e,t,n){if(e.length>t)return e;var i=""+Le(t,n)+e;return i.slice(i.length-t,i.length)},e.padEnd=function Mt(e,t,n){return(""+e+Le(t,n)).slice(0,t)},e.getRepeatedElement=Le,e.isPromise=function Yt(e){return!!e&&"function"==typeof e.then&&"function"==typeof e["catch"]}
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
