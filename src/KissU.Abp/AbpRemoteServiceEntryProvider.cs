...
{
    /// <summary>
    /// RemoteService标记类型的服务条目提供程序。
    /// </summary>
    public class AbpRemoteServiceEntryProvider : IServiceEntryProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbpRemoteServiceEntryProvider" /> class.
        /// </summary>
        /// <param name="types">The types.</param>
        /// <param name="clrServiceEntryFactory">The color service entry factory.</param>
        /// <param name="serviceProvider">The service provider.</param>
        public AbpRemoteServiceEntryProvider(IEnumerable<Type> types, IClrServiceEntryFactory clrServiceEntryFactory, CPlatformContainer serviceProvider)
        {
        ...
        public IEnumerable<ServiceEntry> GetEntries()
        {
            ...
            {
                entries.AddRange(_clrServiceEntryFactory.CreateServiceEntry(service,"api/{RemoteService}/{Async}", IsDisableNetwork, IsEnableAuthorization));
            }
        ...
        private bool IsRemoteService(Type type)
        {
            ...
            //if (type.IsInterface && typeof(IRemoteService) != type && typeof(IRemoteService).IsAssignableFrom(type)&& !typeof(IApplicationService).IsAssignableFrom(type) && !typeof(IInternalService).IsAssignableFrom(type))
            //{
            //    return true;
            //}
        ...
        private bool IsDisableNetwork(MethodInfo methodInfo)
        {
            var remoteServiceAttr = ReflectionHelper.GetSingleAttributeOrDefault<RemoteServiceAttribute>(methodInfo);
            //if (remoteServiceAttr != null && remoteServiceAttr.IsNetworkDisableFor(methodInfo))
            //{
            //    return true;
            //}
