...
import { HttpInterceptor, HttpRequest, HttpHandler, HttpResponse, HttpErrorResponse, HttpEvent, HttpResponseBase } from '@angular/common/http';
...
export class DefaultInterceptor implements HttpInterceptor {
  ...
  private checkStatus(ev: HttpResponseBase) {
    ...
    //if (ev.url.startsWith(environment.AUTH_URL)) return;
  ...
  private handleData(ev: HttpResponseBase): Observable<any> {
    ...
    switch (ev.status) {
      ...
      case 401: // 未登录状态码
        ...
        //this.injector.get(OAuthService).logOut();
