...
namespace KissU.Modules.IdentityServer.Domain.Models.ApiResourceAggregate
{
    ...
    /// </summary>
    [Description("Api资源")]
    public partial class ApiResource : AggregateRoot<ApiResource, Guid>,IDelete,IAudited
    {
        /// <summary>
        /// 初始Api资源
        /// </summary>
        ...
        /// </summary>
        [NotMapped]
        public List<string> UserClaims { get { return Util.Helpers.Convert.ToList<string>(ClaimTypes); } set { ClaimTypes = value.Join(); } }
