...
namespace KissU.Modules.GreatWall.Application.Implements {
    ...
    /// 应用程序查询服务
    /// </summary>
    public class QueryApplicationAppService : QueryServiceBase<ApplicationPo, ApplicationDto, ApplicationQuery>, IQueryApplicationAppService {
        /// <summary>
        /// 初始化应用程序查询服务
        /// </summary>
        ...
        public QueryApplicationAppService( IApplicationPoStore applicationPoStore, IApplicationRepository applicationRepository,
