(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ng-zorro-antd/core'), require('rxjs'), require('@angular/common'), require('@angular/core'), require('date-fns/format'), require('date-fns/get_iso_week'), require('date-fns/parse')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/i18n', ['exports', 'ng-zorro-antd/core', 'rxjs', '@angular/common', '@angular/core', 'date-fns/format', 'date-fns/get_iso_week', 'date-fns/parse'], factory) :
    (factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].i18n = {}),global['ng-zorro-antd'].core,global.rxjs,global.ng.common,global.ng.core,global.fnsFormat,global.fnsGetISOWeek,global.fnsParse));
}(this, (function (exports,core,rxjs,i2,i0,fnsFormat,fnsGetISOWeek,fnsParse) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzI18nService = /** @class */ (function () {
        ...
        /** @nocollapse */ NzI18nService.ngInjectableDef = i0.defineInjectable({ factory: function NzI18nService_Factory() { return new NzI18nService(i0.inject(NZ_I18N, 8), i0.inject(NZ_DATE_LOCALE, 8)); }, token: NzI18nService, providedIn: "root" });
    ...
    var DateHelperService = /** @class */ (function () {
        ...
        DateHelperService.decorators = [
            { type: i0.Injectable, args: [{
                        ...
                        deps: [i0.Injector, [new i0.Optional(), NZ_DATE_CONFIG], i2.DatePipe]
                    },] }
        ];
        /** @nocollapse */
        DateHelperService.ctorParameters = function () {
            return [
                { type: NzI18nService },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [NZ_DATE_CONFIG,] }] }
            ];
        };
        /** @nocollapse */ DateHelperService.ngInjectableDef = i0.defineInjectable({ factory: function DateHelperService_Factory() { return DATE_HELPER_SERVICE_FACTORY(i0.inject(i0.INJECTOR), i0.inject(NZ_DATE_CONFIG, 8), i0.inject(i2.DatePipe)); }, token: DateHelperService, providedIn: "root" });
    ...
    var DateHelperByDateFns = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ DateHelperByDateFns.ngInjectableDef = i0.defineInjectable({ factory: function DateHelperByDateFns_Factory() { return DATE_HELPER_SERVICE_FACTORY(i0.inject(i0.INJECTOR), i0.inject(NZ_DATE_CONFIG, 8), i0.inject(i2.DatePipe)); }, token: DateHelperByDateFns, providedIn: "root" });
    ...
    var DateHelperByDatePipe = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        DateHelperByDatePipe.ctorParameters = function () {
            return [
                { type: NzI18nService },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [NZ_DATE_CONFIG,] }] },
                { type: i2.DatePipe }
        ...
        /** @nocollapse */ DateHelperByDatePipe.ngInjectableDef = i0.defineInjectable({ factory: function DateHelperByDatePipe_Factory() { return DATE_HELPER_SERVICE_FACTORY(i0.inject(i0.INJECTOR), i0.inject(NZ_DATE_CONFIG, 8), i0.inject(i2.DatePipe)); }, token: DateHelperByDatePipe, providedIn: "root" });
