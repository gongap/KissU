(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/keycodes'), require('rxjs/operators'), require('@angular/platform-browser'), require('rxjs'), require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('ng-zorro-antd/core'), require('ng-zorro-antd/empty'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/input')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/cascader', ['exports', '@angular/cdk/keycodes', 'rxjs/operators', '@angular/platform-browser', 'rxjs', '@angular/cdk/overlay', '@angular/common', '@angular/core', '@angular/forms', 'ng-zorro-antd/core', 'ng-zorro-antd/empty', 'ng-zorro-antd/icon', 'ng-zorro-antd/input'], factory) :
    (factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].cascader = {}),global.ng.cdk.keycodes,global.rxjs.operators,global.ng.platformBrowser,global.rxjs,global.ng.cdk.overlay,global.ng.common,global.ng.core,global.ng.forms,global['ng-zorro-antd'].core,global['ng-zorro-antd'].empty,global['ng-zorro-antd'].icon,global['ng-zorro-antd'].input));
}(this, (function (exports,keycodes,operators,platformBrowser,rxjs,overlay,common,core,forms,core$1,empty,icon,input) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzCascaderComponent = /** @class */ (function () {
        ...
        NzCascaderComponent.propDecorators = {
            ...
            overlay: [{ type: core.ViewChild, args: [overlay.CdkConnectedOverlay,] }],
