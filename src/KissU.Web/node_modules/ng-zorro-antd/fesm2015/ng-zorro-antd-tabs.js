...
import { ChangeDetectionStrategy, Component, Input, TemplateRef, ViewEncapsulation, Directive, ElementRef, Renderer2, ContentChild, EventEmitter, Output, ViewChild, NgZone, ChangeDetectorRef, ContentChildren, Optional, NgModule } from '@angular/core';
import { Subject, fromEvent, merge, of, Subscription } from 'rxjs';
...
export { NzTabBodyComponent, NzTabLabelDirective, NzTabComponent, NzTabsInkBarDirective, NzTabsModule, NzTabsNavComponent, NzTabChangeEvent, NzTabSetComponent, NzTabDirective };
