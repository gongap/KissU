...
@NgModule({
    ...
    entryComponents: [
        ...
        ApiScopeEditComponent,ApiScopeDetailComponent,
        ApplicationEditComponent,ApplicationDetailComponent,
        EnterpriseEditComponent,EnterpriseDetailComponent,
        LinkEditComponent,LinkDetailComponent,
        MenuEditComponent,MenuDetailComponent,
