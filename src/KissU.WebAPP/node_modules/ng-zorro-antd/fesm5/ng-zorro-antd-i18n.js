...
import { InjectionToken, Inject, Injectable, Optional, Pipe, NgModule, defineInjectable, inject, Injector, INJECTOR } from '@angular/core';
...
var DateHelperService = /** @class */ (function () {
    ...
    /** @nocollapse */ DateHelperService.ngInjectableDef = defineInjectable({ factory: function DateHelperService_Factory() { return DATE_HELPER_SERVICE_FACTORY(inject(INJECTOR), inject(NZ_DATE_CONFIG, 8), inject(DatePipe)); }, token: DateHelperService, providedIn: "root" });
