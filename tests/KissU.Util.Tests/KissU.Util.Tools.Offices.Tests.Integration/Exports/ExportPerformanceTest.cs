...
namespace KissU.Util.Tools.Offices.Tests.Integration.Exports
{
    ...
    public class ExportPerformanceTest
    {
        ...
        {
            _export.Head("测试报表")
                .Head(new Cell("测试", 1, 3), new Cell("测试", 1, 3), new Cell("测试", 1, 3), new Cell("测试", 2, 2),
                    new Cell("测试", 11))
                ...
                .Body(_list,
                    t => new object[]
                    {
                        t.Test16, t.Test15, t.Test14, t.Test13, t.Test12, t.Test11, t.Test10, t.Test9, t.Test8, t.Test7,
                        t.Test6, t.Test5, t.Test4, t.Test3, t.Test2, t.Test1
                    })
