...
namespace KissU.Util.Tests.Helpers
{
    ...
    public class LambdaTest
    {
        ...
        {
            var attribute = Lambda.GetAttribute<Sample, string, DisplayAttribute>(t => t.StringValue);
        ...
        {
            var attributes = Lambda.GetAttributes<Sample, string, ValidationAttribute>(t => t.StringValue);
        ...
        {
            var test = new Sample
                {StringValue = "a", Test2 = new Sample2 {StringValue = "b", Test3 = new Sample3 {StringValue = "c"}}};
        ...
        public void TestGetValue_Instance()
        {
            var test = new Sample
            {
                ...
                Test2 = new Sample2 {StringValue = "b", Test3 = new Sample3 {StringValue = "c"}}
            };
        ...
        {
            Assert.Equal("t => (t.StringValue == \"A\")",
                Lambda.ParsePredicate<Sample2>("StringValue", "A", Operator.Equal).SafeString());
            Assert.Equal("t => t.StringValue.Contains(\"A\")",
                Lambda.ParsePredicate<Sample2>("StringValue", "A", Operator.Contains).SafeString());
        }
