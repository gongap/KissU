...
using KissU.AuthServer.Host.Areas.Account.Controllers.Models;
...
using UserLoginInfo = KissU.AuthServer.Host.Areas.Account.Controllers.Models.UserLoginInfo;

namespace KissU.AuthServer.Host.Areas.Account.Controllers
{
    ...
    public class AccountController : AbpController
    {
        ...
        [HttpPost]
        [Route("login")]
        public virtual async Task<LoginResult> Login(UserLoginInfo login)
        {
        ...
        [HttpPost]
        [Route("checkPassword")]
        public virtual async Task<LoginResult> CheckPassword(UserLoginInfo login)
        {
            ValidateLoginInfo(login);
