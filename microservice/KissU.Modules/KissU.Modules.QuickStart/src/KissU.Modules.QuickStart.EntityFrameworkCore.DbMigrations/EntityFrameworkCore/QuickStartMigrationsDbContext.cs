...
namespace KissU.Modules.QuickStart.EntityFrameworkCore
{
     ...
     */
    public class QuickStartMigrationsDbContext : AbpDbContext<QuickStartMigrationsDbContext>
    {
        public QuickStartMigrationsDbContext(DbContextOptions<QuickStartMigrationsDbContext> options) 
            : base(options)
        {
