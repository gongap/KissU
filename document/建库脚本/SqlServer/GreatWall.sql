...
--删除数据库
EXEC msdb.dbo.sp_delete_database_backuphistory @database_name = N'KissU.GreatWall'
GO
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'KissU.GreatWall')
Begin
DROP DATABASE [KissU.GreatWall]
End
GO

--创建数据库
CREATE DATABASE [KissU.GreatWall]
GO
