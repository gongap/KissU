...
namespace KissU.GreatWall.Test.Integration.Dtos.Systems {
    ...
    public class ApplicationDtoTest {
        ...
        public void TestToDto() {
            ...
            Assert.Equal( ApplicationTest.Remark,dto.Remark );
            Assert.Equal( ApplicationTest.Extend,dto.Extend );
        ...
        public void TestToEntity() {
            ...
            Assert.Equal( ApplicationTest.Remark,entity.Remark );
            Assert.Equal( ApplicationTest.Extend,entity.Extend );
